            ...
            User.findById(options.userid, function (err, user) {
             ...
             console.log('111aaa');
              if(err){
                    ...
                    user.studentId = options.studentId;
                    
                    user.school.name = optiona.school.name;
                    user.school.major = options.school.major;
                    user.school.currentYear = options.school.currentYear;

                    user.industry.desired = options.industry.desited;
                    user.industry.interestedIn = options.industry.interestedIn;
                    user.industry.secondary = options.industry.secondary;

                    user.industry.previousJobs = user.industry.previousJobs;
                    user.industry.additionalPersonalInfo = user.industry.additionalPersonalInfo;
                    user.coachList = options.coachList;

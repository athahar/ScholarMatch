...
var emailContent = function () {
    ...
    this.welcomeUser = function (userName, role) {
        ...
        if(role.toUpperCase() == "STUDENT"){
            ...
            + "Congratulations, " + userName + "!" + " We have received your request to participate in Career Connections. Thank you for your interest!" + 
                "<br /><br />" + 
                "This is an opportunity for you to partner with a professional who works in your future career and allows you to ask all of your questions about the industry. " +
                    ...
                    "<br />" + 
                    "<ol>" + 
                        "<li>Read and complete the Pre-Intro Call Homework assignment (" + "<a href='http://scholarmatch.org/wordpress/wp-content/uploads/2014/05/C2C-Info-Page.pdf' target='_blank'>click here</a>)</li>" +
                        ...
                        "<li>"+"Respond to this email with:" +
                            "<ul>" + 
                                "<li>Answers to the Pre-Intro Call questions (found in the link in #1)</li>" +
                                "<li>Three questions that you plan to ask your Career Coach</li>" + 
                                "<li>Your availability to schedule an Intro Call call with ScholarMatch staff. <i>**Include 3 different time slots for a 1-hour conversation. During this call, we will review your homework answers, speak about how to partner with your Career Coach, and discuss program details.</i></li>" +
                            "</ul>" +
                        "</li>" +
                    "</ol>" +
                    "<br />" +
            ...
            + "Congratulations, " + userName + "!" + " We have received your request to participate in Career Connections. Thank you for your interest!" + "<br /><br />" + 
                "This is a meaningful opportunity for you to partner with a college student who is interested in your profession or career field. " + 
                    ...
                    "<ol>" + 
                        ...
                        "<li>Respond to this email with your availability for the next 2 weeks for a 20-minute Intro Call Call. " +
    ...
    this.orientationMeeting = function (student, coach, meetingDate) {
        var html = "Dear " + student.name + " &amp; " + coach.name + ". <br/>" + "As a first step of our career connection program, we will have an intro call with both of you introducing each other, and set the expectations by ScholarMatch staff on " + meetingDate + ". <br/> Conference dialin: 650-123-1234, passcode: 1111 " + "<br/><br/>" + " - ScholarMatch team";
        return html;
    }
};

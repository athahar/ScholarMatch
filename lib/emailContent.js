...
var emailContent = function () {
    ...
    this.createMeeting = function (inviteCreator, invited, meeting) {
        ...
        var html = "Hello " + inviteCreator.fullName + " and " + invited.fullName + "," + "<br/>" + "You both have a meeting scheduled" + " on : " + meeting.meetingdate + "<br />Location: " + meeting.meetinglocation + "<br /> Landmark/Description: (" + meeting.meetinglandmark + ")." + "<br/>" + "<br/>" + inviteCreator.fullName + "'s phone number : " + inviteCreator.phone + "<br/>" + invited.fullName + "'s phone number : " + invited.phone + ". " + "<br /><br />" + "If you can't make it please reply to this email." + "<br/>" + "<br/>" + "Topic of discussion : " + meeting.meetingTopic + "<br/>" + "<br/>" + " - ScholarMatch team";
    ...
    this.matchSuccess = function (student, coach) {
        ...
        var text = "Congratulations " + student.fullName + " and " + coach.fullName + "," 
            ...
            "Before your interactions begin, we want to introduce you to each other. Therefore, we need to schedule a brief, 15-minute Introduction Call to 'meet.'"+
                " During this call we will also set goals and decide on the best professional skills to work on together. " +
            "<br /><br />" +
            "Please send an email to <a href='mailto:c2c@scholarmatch.org?Subject=Time Slots Intro Call'>c2c@scholarmatch.org</a> with at least 3 time slots (Day, morning or evening) that work with your schedule within the next 2 weeks." +
            "<br /><br />" +
            "Have a great day!" +
            "<br /><br />" +
             "Questions? <a href='mailto:c2c@scholarmatch.org?Subject=Career Connections Question'>Email Us</a> or call (415) 652 - 2766." +
